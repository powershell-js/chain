...
Page({
  ...
  request: function () {
    ...
    wx.request({
      url: 'https://llr.dangdanggps.com/jycoldchain/ColdRentController/list',
      data: {
        'city': this.data.start.join(),
        'coldArea': this.data.codeArea,
  ...
  choice: function (res) {
    ...
    if (choice == 1) {
      this.setData({
        ...
        wx.navigateTo({
          url: '../leaseRegion/leaseRegion?info=' + res.currentTarget.dataset.choice,
        })
      )
